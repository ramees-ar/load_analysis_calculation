...
class EntityDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model", "name", "_id", "modelId", "userId", "device", "parent", "severity", "attributes", "ancestors", "connections", "entities", "createdAt", "updatedAt", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model", "name", "_id", "modelId", "userId", "device", "parent", "severity", "attributes", "ancestors", "connections", "entities", "createdAt", "updatedAt", ], str]):
        return super().get_item_oapg(name)
