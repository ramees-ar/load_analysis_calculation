...
class ArrayOfV2Entities(
        ...
        class properties:
            ...
            class nodes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V2Entity']:
                        return V2Entity
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V2Entity'], typing.List['V2Entity']],
                ...
                def __getitem__(self, i: int) -> 'V2Entity':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "limit", "skip", "nodes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "limit", "skip", "nodes", ], str]):
