...
class RecentlyUpdatedV2Entity(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            datasources = schemas.DictSchema
            __annotations__ = {
                "id": id,
                "label": label,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "relationship", "meta", "datasources", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "relationship", "meta", "datasources", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        datasources: typing.Union[MetaOapg.properties.datasources, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'RecentlyUpdatedV2Entity':
