...
class CreatedModules(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "object", "methods", "appId", "_id", "type", "createdAt", "updatedAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "object", "methods", "appId", "_id", "type", "createdAt", "updatedAt", ], str]):
