...
class ArrayOfRelatedV2Entities(
        ...
        class properties:
            ...
            class nodes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RelatedV2Entity']:
                        return RelatedV2Entity
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['RelatedV2Entity'], typing.List['RelatedV2Entity']],
                ...
                def __getitem__(self, i: int) -> 'RelatedV2Entity':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "nodes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "nodes", ], str]):
