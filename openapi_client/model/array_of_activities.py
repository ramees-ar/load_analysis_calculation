        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['QueryActivityResult']:
                        return QueryActivityResult
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['QueryActivityResult'], typing.List['QueryActivityResult']],
                ...
                def __getitem__(self, i: int) -> 'QueryActivityResult':
