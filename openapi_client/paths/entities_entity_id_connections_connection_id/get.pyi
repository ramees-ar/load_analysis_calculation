...
SchemaFor200ResponseBodyApplicationJson = EntityConnection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_connection_oapg(
        self,
...
class GetEntityConnection(BaseApi):
    ...
    def get_entity_connection(
        ...
        return self._get_entity_connection_oapg(
