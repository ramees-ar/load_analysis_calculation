...
SchemaFor200ResponseBodyApplicationJson = ArrayOfEntityConnections
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_entity_connections_oapg(
        self,
...
class ListEntityConnections(BaseApi):
    ...
    def list_entity_connections(
        ...
        return self._list_entity_connections_oapg(
