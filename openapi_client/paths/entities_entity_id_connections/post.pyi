...
# body param
SchemaForRequestBodyApplicationJson = CreateEntityConnectionPayload


request_body_create_entity_connection_payload = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = EntityConnection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_connection_oapg(
        self,
    ...
    def _create_entity_connection_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_entity_connection_payload.serialize(body, content_type)
...
class CreateEntityConnection(BaseApi):
    ...
    def create_entity_connection(
        ...
        return self._create_entity_connection_oapg(
            body=body,
