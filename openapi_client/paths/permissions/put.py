...
# body param
SchemaForRequestBodyApplicationJson = CreatePermissionPayload


request_body_create_permission_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Permission
...
class BaseApi(api_client.Api):
    ...
    def _create_permission_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_permission_payload.serialize(body, content_type)
