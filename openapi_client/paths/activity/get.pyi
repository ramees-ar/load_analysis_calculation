...
SchemaFor200ResponseBodyApplicationJson = ArrayOfActivities
...
class QueryActivityData(BaseApi):
    ...
    def query_activity_data(
        ...
        return self._query_activity_data_oapg(
