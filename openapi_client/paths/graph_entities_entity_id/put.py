...
# body param
SchemaForRequestBodyApplicationJson = PatchV2EntityPayload


request_body_patch_v2_entity_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UpdatedV2Entity
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = UpdatedV2Entity
...
class BaseApi(api_client.Api):
    ...
    def _update_v2_entity_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch_v2_entity_payload.serialize(body, content_type)
...
class UpdateV2Entity(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_v2_entity(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_v2_entity(
        ...
        return self._update_v2_entity_oapg(
            body=body,
