...
SchemaFor200ResponseBodyApplicationJson = V2EntityDetails
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = V2EntityDetails
...
class GetV2Entity(BaseApi):
    ...
    def get_v2_entity(
        ...
        return self._get_v2_entity_oapg(
