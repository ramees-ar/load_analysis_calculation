...
# body param
SchemaForRequestBodyApplicationJson = PatchEntityPayload


request_body_patch_entity_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UpdatedEntity
...
class BaseApi(api_client.Api):
    ...
    def _update_entity_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch_entity_payload.serialize(body, content_type)
...
class UpdateEntity(BaseApi):
    ...
    def update_entity(
        ...
        return self._update_entity_oapg(
            body=body,
